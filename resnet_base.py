...
def baseline_model(fine_tune_from=25, fcl_activation='sigmoid'):
    """
...
def dropout_model(fine_tune_from=25, dropout_rate=0.25, fcl_activation='sigmoid'):
    """
...
def batch_norm_model(fine_tune_from=25, fcl_activation='sigmoid'):
    """
...
def weight_decay_model(fine_tune_from=25, fcl_activation='sigmoid', regularizer='l1_l2'):
    """
